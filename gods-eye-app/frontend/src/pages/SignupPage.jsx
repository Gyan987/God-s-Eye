...
const SignupPage = () => {
  ...
  return (
    <section className="glass mx-auto max-w-md rounded-3xl p-6">
      <h1 className="mb-4 text-2xl font-extrabold">Sign Up</h1>
      ...
      <p className="mt-4 text-sm">
        Already have an account? <Link to="/login" className="font-semibold text-ocean dark:text-amber-300">Login</Link>
      </p>
    </section>
  );
};
